...
from wyoming_piper_normalize.normalizer import Normalizer
from wyoming_piper_normalize.piper_tts import PiperTTS
        ...
        with tempfile.NamedTemporaryFile(mode="wb+", suffix=".wav") as output_file:
            async with _VOICE_LOCK:
                if voice_name != _VOICE_NAME:
                    ...
                    _VOICE = PiperTTS().load_voice(voice_name, force_redownload=self.cli_args.update_voices)
